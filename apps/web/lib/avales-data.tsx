...
export const avalesSections: AvalSection[] = [
  ...
  {
    slug: 'higiene-seguridad-industrial',
    title: 'Reglamento de Higiene',
    desc: 'Normas de higiene y seguridad industrial para los trabajadores de la institución.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="space-y-4 text-sage-600/80 leading-relaxed">
        <div className="overflow-hidden rounded-xl border border-sage-200">
          <table className="w-full text-sm">
            <tbody>
              <tr className="border-b border-sage-100 bg-sage-50/50">
                <td className="px-5 py-3 font-semibold text-sage-700 w-52">Nombre o razón social</td>
                <td className="px-5 py-3">Lucila Valencia de Ossa</td>
              </tr>
              <tr className="border-b border-sage-100">
                <td className="px-5 py-3 font-semibold text-sage-700">Identificación (NIT o Cédula)</td>
                <td className="px-5 py-3">C24296966</td>
              </tr>
              <tr className="border-b border-sage-100 bg-sage-50/50">
                <td className="px-5 py-3 font-semibold text-sage-700">Fecha de inicio de vigencia</td>
                <td className="px-5 py-3">12 de octubre de 2017</td>
              </tr>
              <tr className="border-b border-sage-100">
                <td className="px-5 py-3 font-semibold text-sage-700">Clase o tipo de riesgo</td>
                <td className="px-5 py-3">Código: 1 — Clasificación: 5 — Tarifa: 6,96%</td>
              </tr>
              <tr className="bg-sage-50/50">
                <td className="px-5 py-3 font-semibold text-sage-700">Empresa</td>
                <td className="px-5 py-3">Hogar Gerontológico &ldquo;Oasis de Vida&rdquo;</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 text-sm">
          <span className="font-semibold">Parágrafo: </span>
          Con el fin de evitar que los factores de riesgo contemplados en el presente artículo se traduzcan en accidentes de trabajo o enfermedades laborales, la empresa ejercerá el control de dichos riesgos en la fuente, en el medio de transmisión o directamente sobre el trabajador, de conformidad con lo establecido en el Sistema de Gestión de Seguridad y Salud en el Trabajo (SG-SST). Este reglamento será divulgado y dado a conocer a todos los trabajadores vinculados a la institución.
        </div>
        <div className="bg-sage-50 rounded-xl p-4 border border-sage-100">
          <h3 className="font-semibold text-sage-800 mb-1">Artículo 5</h3>
          <p>La empresa y sus trabajadores darán estricto cumplimiento a las disposiciones legales vigentes, así como a las normas técnicas e internas adoptadas para la implementación de las actividades de medicina preventiva y del trabajo, higiene y seguridad industrial, en concordancia con el presente reglamento y con el Sistema de Gestión de Seguridad y Salud en el Trabajo (SG-SST).</p>
        </div>
        <div className="bg-sage-50 rounded-xl p-4 border border-sage-100">
          <h3 className="font-semibold text-sage-800 mb-1">Artículo 6</h3>
          <p>La empresa ha implementado un proceso de inducción para todos los trabajadores antes del inicio de sus labores, capacitándolos sobre las medidas de prevención, seguridad y salud en el trabajo, así como sobre los riesgos propios del ambiente laboral y de las funciones específicas que desempeñarán.</p>
        </div>
        <div className="bg-sage-50 rounded-xl p-4 border border-sage-100">
          <h3 className="font-semibold text-sage-800 mb-1">Artículo 7</h3>
          <p>El presente reglamento permanecerá exhibido en, por lo menos, dos lugares visibles dentro de las instalaciones de la empresa. Su contenido será dado a conocer a todos los trabajadores en el momento de su vinculación laboral.</p>
        </div>
        <div className="bg-sage-50 rounded-xl p-4 border border-sage-100">
          <h3 className="font-semibold text-sage-800 mb-1">Artículo 8</h3>
          <p>El presente reglamento entrará en vigencia a partir de la firma del representante legal y de su publicación oficial, permaneciendo vigente mientras la empresa conserve, sin modificaciones sustanciales, las condiciones existentes al momento de su aprobación, tales como:</p>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>La actividad económica.</li>
            <li>Los métodos de producción.</li>
            <li>Las instalaciones locativas.</li>
            <li>Cualquier otra condición que no implique modificaciones a las normas que regulan este reglamento o que limiten su vigencia.</li>
          </ul>
        </div>
        <div className="p-4 bg-white rounded-xl border border-sage-200 text-sm">
          <p>De conformidad con la Ley 962 de 2005, artículo 55, se elimina el requisito de revisión y aprobación del Reglamento de Higiene y Seguridad Industrial por parte del entonces Ministerio de la Protección Social.</p>
          <p className="mt-2">Asimismo, el artículo 349 del Código Sustantivo del Trabajo establece que:</p>
          <p className="mt-1 italic">&ldquo;Los empleadores que tengan a su servicio diez (10) o más trabajadores permanentes deberán elaborar un Reglamento Especial de Higiene y Seguridad, a más tardar dentro de los tres (3) meses siguientes al inicio de labores, cuando se trate de un nuevo establecimiento. La autoridad competente vigilará el cumplimiento de esta disposición.&rdquo;</p>
        </div>
      </div>
    ),
  },
