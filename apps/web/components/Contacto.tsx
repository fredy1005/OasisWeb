        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <Reveal delay={0.1} className="space-y-6">
            ...
            <div className="pt-8 border-t border-sage-200">
              <h3 className="text-xl font-serif font-bold text-sage-800 mb-5">Sede 2</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <form className="space-y-5 bg-white p-6 md:p-8 rounded-2xl border border-sage-100 shadow-sm">
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Nombre completo</label>
                      <input type="text" name="name" required className="w-full px-4 py-3 rounded-lg border border-sage-200 bg-white focus:outline-none focus:ring-2 focus:ring-sage-400 focus:border-transparent transition-shadow" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Teléfono</label>
                      <input type="tel" name="phone" required className="w-full px-4 py-3 rounded-lg border border-sage-200 bg-white focus:outline-none focus:ring-2 focus:ring-sage-400 focus:border-transparent transition-shadow" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Email</label>
                      <input type="email" name="email" required className="w-full px-4 py-3 rounded-lg border border-sage-200 bg-white focus:outline-none focus:ring-2 focus:ring-sage-400 focus:border-transparent transition-shadow" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-sage-700 mb-1">Mensaje</label>
                      <textarea name="message" rows={4} required className="w-full px-4 py-3 rounded-lg border border-sage-200 bg-white focus:outline-none focus:ring-2 focus:ring-sage-400 focus:border-transparent transition-shadow" />
                    </div>
                ...
                <div className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="flex items-start gap-4 bg-white p-5 rounded-xl border border-sage-100 card-hover">
                      ...
                      <div>
                        <h3 className="font-serif font-semibold text-sage-800 mb-1 text-lg">Visitanos</h3>
                        <p className="text-sage-600/80 text-sm">Cl. 123a # 53-32</p>
                        <a
                          href="https://www.google.com/maps?q=cl+123a+53-32"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-sage-500 hover:text-sage-600 text-sm font-medium inline-flex items-center gap-1 mt-1"
                        >
                  ...
                  <div className="aspect-[16/9] rounded-xl overflow-hidden border border-sage-200 shadow-sm">
                    <iframe
                      src="https://www.google.com/maps?q=cl+123a+53-32&output=embed"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
                      loading="lazy"
                      referrerPolicy="no-referrer-when-downgrade"
                      title="Ubicación de Oasis De Vida - Sede 2"
                    />
                  </div>
                </div>
              </div>
