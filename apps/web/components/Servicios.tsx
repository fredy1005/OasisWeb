...
const servicios = [
  ...
  },
  {
    ...
    desc: 'Médico geriatra con visitas mensuales y guardia pasiva permanente.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Terapias que permiten mantener en la mejor forma las funcionalidades motoras.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
