  ...
  return (
    <section id="avales" className="bg-white">
      <div className="container-section">
        <h2 className="section-title">Avales legales</h2>
        <p className="section-subtitle">Operamos con total transparencia y cumplimiento normativo.</p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {avales.map((a) => (
            <div key={a.title} className="flex items-start gap-4 bg-cream p-5 rounded-xl border border-sage-100 hover:border-sage-300 transition-colors">
              <div className="text-sage-500 shrink-0 mt-0.5">
                {a.icon}
              </div>
              <div>
